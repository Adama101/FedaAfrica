  ...
  Widget build(BuildContext context) {
    return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return buildLockedLessonCard(context, lessons[index]);
        }
        },
      );
  }
  Widget buildLockedLessonCard(BuildContext context, Lesson lesson) {
    return Container(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  lesson.description,
                  style: TextStyle(color: Colors.grey[600]), // Adjust the color as needed
                ),
              ],
            ),
          ),
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            ...
            builder: (context) => QuestionScreen(
              lesson: lesson,
              onLessonCompleted: () {
                // Update the state of the next lesson
                if (lessons.indexOf(lesson) < lessons.length - 1) {
                  lessons[lessons.indexOf(lesson) + 1].completed = true;
                }
              },
              ),
          ),
...
class QuestionScreen extends StatefulWidget {
  ...
  QuestionScreen({required this.lesson, required this.onLessonCompleted});
  @override
