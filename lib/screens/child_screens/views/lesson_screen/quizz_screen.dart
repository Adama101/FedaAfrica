...
//   QuizzScreen(this.current_lesson, this.current_level);

//   @override
//   State<StatefulWidget> createState() {
//     return QuizzScreenState();
//   }
// }
...
//     var lesson_questions =  create_lesson_Questions(widget.current_lesson.questions,widget.current_level,widget.current_lesson);
//     percent = calculateQuizzProgress(index, widget.current_lesson.questions.length);
//     return Scaffold(
//       appBar: LessonAppBar(percent: percent),
//       body: lesson_questions[index],
//     );
//   }
...
//           question_lesson:questions_lesson[i], // Use index 'i' instead of fixed index '2'
//         ),
//       );
//     }
//     return widgets;
