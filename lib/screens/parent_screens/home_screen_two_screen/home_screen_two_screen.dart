...
import 'widgets/wallet1_item_widget.dart';
...
class HomeScreenTwoScreen extends StatelessWidget {
  HomeScreenTwoScreen({Key? key}) : super(key: key);
    ...
    return Padding(
        ...
        child: CarouselSlider.builder(
            ...
            itemBuilder: (context, index, realIndex) {
              return Wallet1ItemWidget(onTapFourteen: () {
                            ...
                            SizedBox(
                                ...
                                child: EasyDateTimeLine(
                                    ...
                                    headerProps: EasyHeaderProps(
                                        ...
                                        showHeader: false),
                                    dayProps:
                                        EasyDayProps(width: 65.h, height: 71.v),
