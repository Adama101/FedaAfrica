...
class VideoFivePlayer extends StatefulWidget {
  final String videoPath;

  const VideoFivePlayer({Key? key, required this.videoPath})
      : super(key: key);

  @override
  _VideoFivePlayerState createState() =>
      _VideoFivePlayerState();
}

GlobalKey<NavigatorState> navigatorKey = GlobalKey();

class _VideoFivePlayerState extends State<VideoFivePlayer> {
