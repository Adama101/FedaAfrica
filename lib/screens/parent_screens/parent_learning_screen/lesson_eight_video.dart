...
class VideoEightPlayer extends StatefulWidget {
  final String videoPath;

  const VideoEightPlayer({Key? key, required this.videoPath})
      : super(key: key);

  @override
  _VideoEightPlayerState createState() =>
      _VideoEightPlayerState();
}

GlobalKey<NavigatorState> navigatorKey = GlobalKey();

class _VideoEightPlayerState extends State<VideoEightPlayer> {
