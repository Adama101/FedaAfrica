...
class VideoFourPlayer extends StatefulWidget {
  final String videoPath;

  const VideoFourPlayer({Key? key, required this.videoPath})
      : super(key: key);

  @override
  _VideoFourPlayerState createState() =>
      _VideoFourPlayerState();
}

GlobalKey<NavigatorState> navigatorKey = GlobalKey();

class _VideoFourPlayerState extends State<VideoFourPlayer> {
