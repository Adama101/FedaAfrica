...
class VideoNinePlayer extends StatefulWidget {
  final String videoPath;

  const VideoNinePlayer({Key? key, required this.videoPath})
      : super(key: key);

  @override
  _VideoNinePlayerState createState() =>
      _VideoNinePlayerState();
}

GlobalKey<NavigatorState> navigatorKey = GlobalKey();

class _VideoNinePlayerState extends State<VideoNinePlayer> {
