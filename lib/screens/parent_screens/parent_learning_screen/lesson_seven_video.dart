...
class VideoSevenPlayer extends StatefulWidget {
  final String videoPath;

  const VideoSevenPlayer({Key? key, required this.videoPath})
      : super(key: key);

  @override
  _VideoSevenPlayerState createState() =>
      _VideoSevenPlayerState();
}

GlobalKey<NavigatorState> navigatorKey = GlobalKey();

class _VideoSevenPlayerState extends State<VideoSevenPlayer> {
