...
class VideoSixPlayer extends StatefulWidget {
  final String videoPath;

  const VideoSixPlayer({Key? key, required this.videoPath})
      : super(key: key);

  @override
  _VideoSixPlayerState createState() =>
      _VideoSixPlayerState();
}

GlobalKey<NavigatorState> navigatorKey = GlobalKey();

class _VideoSixPlayerState extends State<VideoSixPlayer> {
