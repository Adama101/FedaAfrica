...
class VideoTenPlayer extends StatefulWidget {
  final String videoPath;

  const VideoTenPlayer({Key? key, required this.videoPath})
      : super(key: key);

  @override
  _VideoTenPlayerState createState() =>
      _VideoTenPlayerState();
}

GlobalKey<NavigatorState> navigatorKey = GlobalKey();

class _VideoTenPlayerState extends State<VideoTenPlayer> {
