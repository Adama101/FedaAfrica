...
class VideoTwoPlayer extends StatefulWidget {
  final String videoPath;

  const VideoTwoPlayer({Key? key, required this.videoPath})
      : super(key: key);

  @override
  _VideoTwoPlayerState createState() =>
      _VideoTwoPlayerState();
}

GlobalKey<NavigatorState> navigatorKey = GlobalKey();

class _VideoTwoPlayerState extends State<VideoTwoPlayer> {
  late VideoPlayerController _controller;

  @override
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/video_two.mp4')
      ..initialize().then((_) {
        setState(() {});
      })
      ..addListener(() {});
