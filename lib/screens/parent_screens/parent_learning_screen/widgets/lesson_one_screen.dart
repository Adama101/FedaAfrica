...
class lessonOneScreen extends StatelessWidget {
  const lessonOneScreen({Key? key, required String videoPath}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        ...
        Navigator.pushNamed(context, AppRoutes.videoOneScreen);
      },
      child: Padding(
